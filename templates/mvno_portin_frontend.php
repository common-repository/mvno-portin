...
//        echo "<pre>";print_r($current_user);echo "</pre>";
        ...
        <form method="post" action="">
            ...
            <input type="hidden" value="<?=get_current_user_id()?>">

            <label for="phone">Phone</label>
            <input type="text" name="phone_number" id="mvno_portin_phone" class="regular-text">

            <label for="zip_code">Zip</label>
            <input type="text" name="zip_code" id="mvno_portin_zip_code" class="regular-text">
...
//            submit_button( __( 'Verify', 'textdomain' ), 'primary', 'mvno_verify_btn' );
            ?>
            <br>
            <button class="mvno_portin_eligible">Verify</button>
        </form>

    </div>
        <div class="form-wrap mvno_portin_div" style="display: none;">
            ...
            <form method="post" action="">
                ...
                <input type="text" name="first_name" id="first_name" class="regular-text" value="<?=$current_user->user_firstname?>">

                <label for="last_name">Last Name</label>
                <input type="text" name="last_name" id="last_name" class="regular-text" value="<?=$current_user->user_lastname?>">
                ...
                <select name="state" id="state" style="width: 100%; padding: 10px" class="regular-text">
                ...
                <input type="text" name="plan" id="plan" class="regular-text">
                <br>
                <?php
                wp_nonce_field("mvno_port_verification", "port_verification");
                ?>
                <input type="submit" value="Portin" name="mvno_portin_submit">
            </form>

            <div>
                <p class="mvno_portin_msg"></p>
            </div>
        </div >
